...
<!-- Page Content -->
	<div class="w3-overlay w3-animate-opacity" onclick="w3_close()" style="cursor:pointer" id="myOverlay"></div>
		<div>
			...
			<div class="container">
            <h2 class="text-center">Form Pembayaran SPP</h2>
			<form action = "sppbayar.php" method="post">
				...
				<div class="form-group">
                    <div class="form-row">
						<div class="col">
                            <p style="margin-bottom:4px;color:black" >Tanggal (bulan/hari/tahun)</p><input type="date" name="tanggal" class="form-control" id="tanggal"/></div>
						<div class="col">                    
							<p style="margin-bottom:4px;color:black">Masukkan Jumlah uang</p><input class="form-control" type="text" name="uang"></div>
                    </div>
                </div>
				<div class="form-group d-flex justify-content-end">
					<a class="btn btn-primary" href="spp.php" style="margin-right:9px;background-color:rgb(25,132,231);">Batal</a>
