        ...
        <div class="container"><a class="navbar-brand" href="index-users.php">DayCare</a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse"
                ...
                if ($_SESSION['email']==true){
                    ...
                    echo $email;}
                ?> </a>
                <div class="dropdown-menu" role="menu"><a class="dropdown-item" role="presentation" href="/daycare/users/profile.php">Profile</a><a class="dropdown-item" role="presentation" href="#">Second Item</a><a class="dropdown-item" role="presentation" href="/daycare/logout.php">logout</a></div>
        </div>
    </nav>
