...
<table class="table table-responsive-md table-striped text-center">
    ...
    $query = $db->prepare("SELECT * FROM spp WHERE nis = :nis");
    ...
    <tr style="background-color:rgb(240,240,240,0.3);">
		...
		<td><?php echo "<a class='btn btn-primary' style='background-color:rgb(25,132,231)' href='spphapus.php?id=".$row['id']."' >Hapus</a>"; ?></td>
	</tr>
		<?php $no++; ?>                    
        <?php endforeach; ?>
    </tbody>
