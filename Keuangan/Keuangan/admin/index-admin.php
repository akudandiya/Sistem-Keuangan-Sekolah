...
<body class="header-blue">
    ...
    <div class="projects-horizontal" style="background-color:rgba(255,255,255,0);">
        <div class="container">
                <h2 class="text-center">Data Daycare </h2>
				<a href="#" data-target="#tambahdaycare" data-toggle="modal">[+] Tambah Baru</a>
				<h3 class="text-center"></h3>
                <?php include 'datadaycare.php';?>
				<h2 class="text-center"></h2>
				<h2 class="text-center">Data Users </h2>
				<?php include 'datausers.php'; ?>
				<h2 class="text-center"></h2>
				<h2 class="text-center">Data Contact Us</h2>
				<?php include 'datacontactus.php'; ?>
                </div>
            </div>
        </div>
    </div>
	...
	<div class="visible" style="background-image:url(&quot;linier-gradient&quot;);">
        <div class="modal fade" role="dialog" tabindex="-1" id="tambahdaycare" aria-labelledby="emodal">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></div>
                    <div class="modal-body">
                        <form action = "tambahdaycare.php" class="justify-content-center align-items-center align-content-center align-self-center mx-auto" method="post" style="width:320px;height:auto;margin:0px 336px;padding:auto;">
                            <h2 class="text-center" style="font-size:24px;color:rgb(0,0,0);">Tambah Data Daycare</h2>
                            <div class="form-group"><input class="form-control" type="daycarename" name="daycarename" placeholder="Nama Daycare"></div>
							<div class="form-group"><input class="form-control" type="alamat" name="alamat" placeholder="Alamat"></div>
							<div class="form-group"><input class="form-control" type="email" name="email" placeholder="Email"></div>
                            <div class="form-group"><input class="form-control" type="city" name="city" placeholder="Kota"></div>
							<div class="form-group"><textarea class="form-control" rows="14" name="deskripsi" placeholder="Deskripsi " maxlength="255"></textarea></div>
                            <div class="form-group"><button class="btn btn-primary btn-block" name="tambahdaycare" type="submit" style="background-color:rgb(25,132,231);">Tambah</a></div></form>
                    </div>
                    <div class="modal-footer"></div>
                </div>
            </div>
