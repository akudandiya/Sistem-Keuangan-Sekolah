...
<!-- Page Content -->
	<div class="w3-overlay w3-animate-opacity" onclick="w3_close()" style="cursor:pointer" id="myOverlay"></div>
		<div>
			...
			<div class="container">
            <h2 class="text-center">PPDB</h2>
			<form action = "ppdbbayar.php" method="post">
				...
				<div class="form-group d-flex justify-content-end">
					<a class="btn btn-primary" href="ppdb.php" style="margin-right:9px;background-color:rgb(25,132,231);">Batal</a>
