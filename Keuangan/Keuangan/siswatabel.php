...
<table class="table table-responsive-md table-striped text-center">
    ...
    <tr style="background-color:rgb(240,240,240,0.3);">
		...
		<td><?php echo date("d/m/Y", strtotime($row['tahun'])); ?></td>
		<td><?php echo "<a class='btn btn-primary' style='background-color:rgb(25,132,231)' href='siswaedit.php?nis=".$row['nis']."'>Edit</a>"; ?></td>
        <td><?php echo "<a class='btn btn-primary' style='background-color:rgb(25,132,231)' href='siswahapus.php?nis=".$row['nis']."' >Hapus</a>"; ?></td>
    </tr>
